...
def test_first_moves_san_uses_san_notation_consistently():
    ...
    direct     = "1. d4 Nf6 2. c4 e6 3. Nc3 d5 4. Nf3 Be7 *"
    transposed = "1. d4 d5  2. c4 e6 3. Nc3 Nf6 4. Nf3 Be7 *"
    assert first_moves_san(direct) != first_moves_san(transposed)
